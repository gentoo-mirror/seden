...
inherit desktop eutils gnome2-utils java-pkg-2 xdg-utils
...
src_install() {
	...
	cp -r \
		{configuration,d{ataminer,ropins,vt},e{quinox,xternal},ide,j{avavm,d{bc,ev},lib,views}} \
		{module{,s},netbeans,orakafka,rdbms,s{leepycat,ql{developer,j},vnkit}} \
